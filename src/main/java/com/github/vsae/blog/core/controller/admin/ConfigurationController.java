...
public class ConfigurationController {
    ...
    @ResponseBody
    public CommonResult website(@RequestParam(value = "websiteName", required = false) String websiteName,
    ...
    @ResponseBody
    public CommonResult userInfo(@RequestParam(value = "yourAvatar", required = false) String yourAvatar,
    ...
    @ResponseBody
    public CommonResult footer(@RequestParam(value = "footerAbout", required = false) String footerAbout,
