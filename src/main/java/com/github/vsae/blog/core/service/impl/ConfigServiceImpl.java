...
import com.github.vsae.blog.core.service.ConfigService;
import com.github.vsae.blog.core.dao.BlogConfigMapper;
...
public class ConfigServiceImpl implements ConfigService {
    ...
    public static final String websiteName = "my blog";
    public static final String websiteDescription = "my blog is spring boot web site";
    ...
    public static final String yourEmail = "vsae8538@gmail.com";
    public static final String yourName = "vsae";

    public static final String footerAbout = "my blog. have fun.";
    public static final String footerICP = "1234567890";
    public static final String footerCopyRight = "@2019 vsae";
    public static final String footerPoweredBy = "my blog";
